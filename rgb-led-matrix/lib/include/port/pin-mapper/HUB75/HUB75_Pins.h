...
namespace rgb_matrix {
  struct HUB75_t {
    HUB75_Pins(uint32_t r0, uint32_t g0, uint32_t b0, uint32_t r1, uint32_t g1, uint32_t b1)
  ...
  struct HUB75_Pins : public PinMapping {
    public:
      HUB75_Pins(char *name, uint32_t clk, uint32_t lat, HUB75_t p)
          : PinMapping(name), clk(1 << clk), lat(1 << lat), num(1), p0(p) {}

      HUB75_Pins(char *name, uint32_t clk, uint32_t lat, HUB75_t p0, HUB75_t p1)
          : PinMapping(name), clk(1 << clk), lat(1 << lat), num(2), p0(p0), p1(p1) {}

      HUB75_Pins(char *name, uint32_t clk, uint32_t lat, HUB75_t p0, HUB75_t p1, HUB75_t p2)
